  ...
  List<PostEntity> _getMockPosts() {
    return [
      ...
      PostEntity(
        ...
        userLocation: 'Kigali',
        userAvatarUrl: '',
        content: 'Character design for a new project. Meet Luna!',
        imageUrls: ['eiffel_tower'],
        tags: ['illustration', 'characterdesign'],
        likes: 289,
        comments: 0,
        isLiked: false,
        isSaved: false,
      ...
      PostEntity(
        ...
        userLocation: 'Kigali',
        userAvatarUrl: '',
        content: 'Comic book series in progress. Inspired by Rwandan folklore! @AlineMukarurangwa check this out.',
        imageUrls: [],
        tags: ['comics', 'folklore'],
        likes: 412,
        comments: 0,
        isLiked: false,
        isSaved: false,
